...
CREATE TABLE `announce` (
  `aid` int(12) NOT NULL AUTO_INCREMENT COMMENT '通知编号',
...
CREATE TABLE `choice` (
  `cid` int(12) NOT NULL AUTO_INCREMENT COMMENT '志愿编号',
  `pid` int(12) NOT NULL COMMENT '项目id',
  `mid` int(12) NOT NULL COMMENT '人员id',
  `tinyint` int(1) NOT NULL COMMENT '类型 1第一志愿 2第二志愿 3第三志愿',
  PRIMARY KEY (`cid`),
  KEY `pid` (`pid`),
  KEY `mid` (`mid`),
  CONSTRAINT `choice_ibfk_1` FOREIGN KEY (`pid`) REFERENCES `project` (`pid`),
  CONSTRAINT `choice_ibfk_2` FOREIGN KEY (`mid`) REFERENCES `member` (`mid`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8;

/*Data for the table `choice` */

insert  into `choice`(`cid`,`pid`,`mid`,`tinyint`) values (1,1,2,1),(2,2,3,2),(3,3,4,0),(4,4,5,1),(5,5,6,2),(6,6,7,0),(7,7,8,1),(8,8,9,2),(9,9,10,0);
...
CREATE TABLE `member` (
  `mid` int(12) NOT NULL AUTO_INCREMENT COMMENT '人员编号',
  `username` char(11) NOT NULL COMMENT '用户名（学号）',
  ...
  `teacherid` int(12) DEFAULT NULL COMMENT '学生的老师id',
  `projectid` int(12) DEFAULT NULL COMMENT '项目id',
...
CREATE TABLE `pm` (
  `pmid` int(12) NOT NULL AUTO_INCREMENT COMMENT '项目学生表',
  `pid` int(12) NOT NULL COMMENT '项目id',
  `mid` int(12) NOT NULL COMMENT '学生id',
  PRIMARY KEY (`pmid`),
  KEY `pid` (`pid`),
  KEY `mid` (`mid`),
  CONSTRAINT `pm_ibfk_1` FOREIGN KEY (`pid`) REFERENCES `project` (`pid`),
  CONSTRAINT `pm_ibfk_2` FOREIGN KEY (`mid`) REFERENCES `member` (`mid`)
) ENGINE=InnoDB AUTO_INCREMENT=19 DEFAULT CHARSET=utf8;

/*Data for the table `pm` */

insert  into `pm`(`pmid`,`pid`,`mid`) values (1,1,1),(2,2,2),(3,3,3),(4,4,4),(5,5,5),(6,6,6),(7,7,7),(8,8,8),(9,9,9),(10,1,2),(11,2,3),(12,3,4),(13,4,5),(14,5,6),(15,6,7),(16,7,8),(17,8,9),(18,9,10);
...
CREATE TABLE `project` (
  `pid` int(12) NOT NULL AUTO_INCREMENT COMMENT '项目编号',
  `teacherid` int(12) NOT NULL COMMENT '教师id',
  ...
  `teachername` varchar(12) NOT NULL COMMENT '教师名称',
  `isfull` tinyint(1) DEFAULT '0' COMMENT '是否满人',
